...
async def main():
    ...
    parser.add_argument("--simulation", "-s", action="store_true", default=None, help="Run in simulation mode")
    ...
    # Create and run bot
    simulation = args.simulation if args.simulation is not None else config.simulation_mode
    bot = TradingBot(config=config, simulation=simulation)
