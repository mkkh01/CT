...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            execution_timeframe=os.getenv("EXECUTION_TIMEFRAME", "15m").strip(),
            ...
            maker_fee_pct=float(os.getenv("MAKER_FEE_PCT", "0.001")),
    ...
    def live_execution_ready(self) -> tuple[bool, str]:
        ...
        if not self.binance_api_key or not self.binance_api_secret:
            return False, "missing_binance_execution_credentials"
        if self.execution_mode == "live" and not self.live_trading_enabled:
            return False, "live_trading_disabled"
        if self.execution_mode == "live" and self.live_trading_confirmation != "I_UNDERSTAND_LIVE_TRADING_RISK":
            return False, "live_confirmation_missing"
        return True, "ready"
